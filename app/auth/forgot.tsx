...
function SuccessView({ email, onBack }: { email: string; onBack: () => void }) {
    ...
    return (
        <Animated.View style={[styles.successWrap, { opacity }]}>
            ...
            <Animated.View style={[styles.successIconOuter, { transform: [{ scale }] }]}>
...
export default function ForgotPasswordScreen() {
    ...
    const handleSend = () => {
        ...
        setError("");
        setLoading(true);
        // Simulate sending — replace with real auth
    ...
    return (
        <View style={[styles.root, { backgroundColor: "#FFF8F0" }]}>
            ...
            <LinearGradient colors={GRAD} style={[styles.topBand, { paddingTop: insets.top }]}>
                <Animated.View
                    style={[styles.headerRow, { transform: [{ translateY: headerY }], opacity: headerOp }]}
                >
                            ...
                            <View style={styles.card}>
                                ...
                                <Animated.View style={[styles.inputBox, { borderColor }, error && { borderColor: COLORS.danger }]}>
                                    <Ionicons
                                        name="mail-outline"
                                        size={18}
                                        color={focused ? COLORS.primary : "#C0B8B0"}
                                    />
                                    <TextInput
...
const styles = StyleSheet.create({
    ...
    body: {
        flex: 1, paddingHorizontal: SPACE.xl, paddingTop: SPACE.xl,
    },
    ...
    title: {
        fontSize: 26, fontWeight: FONT.black,
        color: "#1A1A1A", letterSpacing: -0.5, textAlign: "center",
    },
    subtitle: {
        fontSize: FONT.base, color: "#888",
    ...
    inputLabel: {
        ...
        color: "#888", letterSpacing: 0.6, textTransform: "uppercase",
    },
    inputBox: {
        flexDirection: "row", alignItems: "center",
    ...
    submitBtn: {
        ...
        borderRadius: RADIUS.xl, minHeight: 52, flexDirection: "row", gap: SPACE.sm,
    },
    submitBtnText: { fontSize: FONT.md, fontWeight: FONT.black, color: "#fff", letterSpacing: 0.3 },

    backLinkRow: {
        flexDirection: "row", alignItems: "center",
        justifyContent: "center", gap: SPACE.xs,
        marginTop: SPACE.xl,
    },
    ...
    successWrap: {
        ...
        gap: SPACE.xl, paddingHorizontal: SPACE.md,
    },
    successIconOuter: {
        borderRadius: 36,
        ...SHADOW.lg,
    ...
    backToLoginBtnText: {
        fontSize: FONT.md, fontWeight: FONT.black, color: "#fff", letterSpacing: 0.3,
    },
});