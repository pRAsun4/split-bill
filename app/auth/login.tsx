...
function AuthInput({
    ...
    return (
        <Animated.View style={[styles.inputWrap, { transform: [{ translateY: slideAnim }], opacity: opacityAnim }]}>
            ...
            <Animated.View style={[styles.inputBox, { borderColor }, error && styles.inputBoxError]}>
                <Ionicons name={icon as any} size={18} color={focused ? COLORS.primary : "#C0B8B0"} style={styles.inputIcon} />
                <TextInput
                ...
                {isPassword && (
                    <TouchableOpacity onPress={() => setShowPassword((p) => !p)} style={styles.eyeBtn}>
                        <Ionicons name={showPassword ? "eye-off-outline" : "eye-outline"} size={18} color="#C0B8B0" />
                    </TouchableOpacity>
                )}
            </Animated.View>
            {error ? (
...
function GoogleBtn({ onPress, delay }: { onPress: () => void; delay: number }) {
    ...
    return (
        <Animated.View style={[{ transform: [{ scale: scaleAnim }] }, { opacity: opacityAnim, transform: [{ scale: scaleAnim }, { translateY: slideAnim }] }]}>
            <TouchableOpacity
                onPress={onPress}
                onPressIn={onIn}
                onPressOut={onOut}
...
export default function LoginScreen() {
    ...
    const handleGoogle = () => {
        // Placeholder — integrate Google Auth here
        router.replace("/(tabs)");
    };
            ...
            >
                ...
                >
                    ...
                    <View style={styles.card}>
                        ...
                        {/* Forgot password */}
                        <Animated.View style={styles.forgotRow}>
                        ...
                        {/* Google */}
                        <GoogleBtn onPress={handleGoogle} delay={320} />
                    </View>
